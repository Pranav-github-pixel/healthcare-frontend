...
import { Stethoscope, Calendar, Clock, LogOut, Sparkles, Settings } from 'lucide-react'
...
export default function DoctorLayout() {
  ...
  const navItems = [
    { label: 'Schedule Stream', path: '/doctor', icon: Calendar },
    { label: 'Working Hours', path: '/doctor/hours', icon: Clock },
  ]

  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-mono transition-colors duration-500">
      {/* Real-time Notification Banner for Live Bookings */}
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            <Link to="/" className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-2xl bg-secondary flex items-center justify-center text-secondary-foreground shadow-sm font-bold">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="font-bold text-foreground truncate max-w-[160px] pr-1">
